...
- Output your `PUBLIC_CONVEX_URL` and `PUBLIC_CONVEX_SITE_URL` values in `.env.local`
...
```env
# These are auto-generated by Convex when you run 'convex dev'
# They will get picked up by @mmailaender/convex-better-auth-svelte
